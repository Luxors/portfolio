! function (e, n) {
  "function" == typeof define && define.amd ? define(n) : "object" == typeof exports ? module.exports = n(require, exports, module) : e.exitpopup = n()
}(this, function (e, n, o) {
  return function (e, n) {
    "use strict";
    ...
    var l = n || {},
      ...
      T = l.cookieName ? l.cookieName : "viewedExitpopupModal",
      w = l.sitewide === !0 ? ";path=/" : "",
      D = null,
...
if(/Android|BlackBerry|iPhone|iPad|iPod|webOS|IEMobile|Opera Mini/i.test(navigator.userAgent) === false) {
  var exitpopup = exitpopup(document.getElementById('exitPopup'), {
    aggressive: true,
  });
}
...
$('body').on('click', function () {
  $('#exitPopup').hide();
  $(this).removeClass('overflowhide');
});
$('#exitPopup .exit-popup').on('click', function (e) {
  e.stopPropagation();
});